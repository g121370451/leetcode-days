...
public class D20240113 {
    ...
    public boolean swapCharArray(char[] arr, char pre, int preIndex) {
        for (int tempIndex = preIndex + 1; tempIndex < arr.length; tempIndex++) {
            if (arr[tempIndex] < pre){
...
//    }
    ...
    public static void main(String[] args) {
        ...
        System.out.printf(d.repeatLimitedString("robnsdvpuxbapuqgopqvxdrchivlifeepy", 2));
    }
}
